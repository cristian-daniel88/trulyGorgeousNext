...
import { ContainerLogoAndH2, Designer, H1Container, Header, Li, LinkA, Logo, LogoContainer, MenuBurguer, Navegador, Ul, LinkAHome,  PopUp, PopUpUl, PopUpLi, BoxContact, IconFaceBook, IconInstagram, IconPhone, AInstagram, TelophoneNumber, TelephoneNumber2 } from './NavStyles'
    ...
    <Header>
        ...
        <Navegador>
            <Ul>
                ...
                <Li onClick={fucusHome} onMouseEnter={popUpWeddingIn} onMouseLeave={popUpWeddingOut}>
                <LinkA href={'/wedding-dresses'}>
                <div onClick={popUpWeddingOut}>
                Wedding Dresses
                </div>
                </LinkA>  
                <PopUp  popUp={popUpWed ? 'true' : 'false'} >
                   ...
                   <LinkA href={'/fairytale'}>
                    <PopUpLi onClick={popUpWeddingOut}>
                            Fairytale
                    </PopUpLi>
                   </LinkA>
                ...
                <Li onClick={fucusHome} onMouseEnter={popUpDesignersIn} onMouseLeave={popUpDesignersOut}>
                 <LinkA href={'/designers'}>
                 <div onClick={popUpDesignersOut}>
                 Designers    
                </div>    
                 </LinkA>    
                 <PopUp popUp={popUpDes ? 'true' : 'false'} style={{'width':'180px'}}>
                    <PopUpUl popUp={popUpDes ? 'true' : 'false'}>
                      <LinkA href='/ronald-joyce' >
                       <PopUpLi onClick={popUpDesignersOut}>
                            Ronald Joyce
                       </PopUpLi>
                      </LinkA>
                ...
                <Li onClick={fucusHome} onMouseEnter={popUpAlterationsOut} onMouseLeave={popUpAlterationsIn}>
               <LinkA href={'/alterations'}>
               <div onClick={popUpAlterationsIn}>
               Alterations 
               </div>  
               </LinkA>   
                <PopUp popUp={popUpAlt ? 'true' : 'false'} style={{'width':'140px'}}>
